...
<body>
        <div class="row">
            <div class="col-9">
                <textarea class="localform_ymn" placeholder="地域名で検索" rows="1" maxlength="100"></textarea>
            </div>
            <div class="col-3">
        ...
        <div class="row">
            <div class="col-9">
                <textarea class="keywordform_ymn"placeholder="キーワードで検索" rows="1" maxlength="100"></textarea>
            </div>
            <div class="col-3">
                <form action="10_検索結果.php" method="post">
                    <input type="submit" class="reserchsend_ymn" value="送信" style="background-color: #7dcfff;">

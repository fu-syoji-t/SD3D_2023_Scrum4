...
<body>
    <div class="row">
        ...
        <div class="col-5">
            <div id="user-id_nh">id:○○○○</div>
            <div id="follower_nh">71</div>
            <div id="follower-text_nh">フォロワー</div>
        </div>
        <div class="col-3">    
            <div id="another-follow_nh">17</div>
            <div id="another-follow-text_nh">フォロー</div>
        </div>
    </div>
    <div class="col-" id="user-name_nh">そたこ</div>
    <div class="profile-self-introduction_nh">うふふ^^;</div>

            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="proup38_ymn">
                                <img class="iconimage_ymn proup39_ymn" src="img/11_yamasutagourmet_color.png">
                            </div>
                ...
                <div class="row">
                    <div class="col-6" id="btn_nh">
                        <button type="submit" class="profileup_ymn" onclick="location.href='03_home.html'" class="btn container-fluid color_white_yamani">キャンセル</button>
                    </div>
                    <div class="col-6" id="btn_nh">
